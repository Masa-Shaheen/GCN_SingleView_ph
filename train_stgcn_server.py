...
def plot_early_stopping(history, best_epoch, save_dir):
    """Show where early stopping fired relative to the best epoch."""
    epochs = range(1, len(history['train_acc']) + 1)
    fig, ax = plt.subplots(figsize=(10, 4))
    ax.plot(epochs, history['val_acc'],   label='Val Accuracy',   color='darkorange')
    ax.plot(epochs, history['train_acc'], label='Train Accuracy', color='steelblue',
            alpha=0.6)
...
for epoch in range(1, EPOCHS + 1):
    ...
    for k, v in [
        ...
        ('train_cls_loss', tr['cls_loss']), ('val_cls_loss', vl['cls_loss']),
        ('train_reg_loss', tr['reg_loss']), ('val_reg_loss', vl['reg_loss']),
        ('train_acc',      tr['accuracy']), ('val_acc',      vl['accuracy']),
...
sys.stdout.restore()
print('✓ Log file closed and saved.')1~import os
